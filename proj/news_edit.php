        ...
        <div class="card-body">
            ...
            <form name="form1" onsubmit="checkData();return false;" novalidate>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control" id="eventtime" name="event_time" value="<?= $row['event_time'] ?>">
                        <div class="form-text red"></div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-10">
                        <?php foreach ($opt as $o) : ?>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="type_sid" id="type-<?= $o['ty_sid'] ?>" value="<?= $o['ty_sid'] ?>" <?= $row['type_sid'] == $o['ty_sid'] ? 'checked' : '' ?>>
                    ...
                    <div class="col-sm-10 d-flex flex-wrap">
                        <?php foreach ($tags as $t) : ?>
                            <div class="form-check mx-2">
                                ...
                                <?php for ($i = 0; $i < count($tagselected); $i++) {
                                      if ($tagselected[$i]['tag_sid'] == $t['tg_sid']) { 
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control" id="publishdate" name="publish_date" value="<?= $row['publish_date'] ?>">
                        <div class="form-text red"></div>
...
<script>
    ...
    async function checkData() {
        ...
        const r = fetch('news_edit_api.php', {
                method: 'POST',
                body: fd
            }).then(r => {
                return r.json()
